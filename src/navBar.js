...
const navBar = () => {
  return (
   <div >
     ...
     <a style={{color:"orange",textDecoration:"none"}} href="https://radiantresort.netlify.app/"><span style={{color:'#006400'}}>༺</span> <span style={{fontStyle:'italic',fontSize:'70px'}}>𝓡</span>𝒶𝒹𝒾𝒶𝓃𝓉 𝓋𝒶𝓁𝓁𝑒𝓎 𝓇𝑒𝓈𝑜𝓇𝓉 <span style={{color:'#006400'}}>༺</span> </a>
