...
const navBar = () => {
  return (
   <div >
    ...
    <span style={{color:'#006400'}}>༺</span> <span style={{fontStyle:'italic',fontSize:'70px',color:"orange"}}>𝓡</span><span style={{color:'orange'}}>𝒶𝒹𝒾𝒶𝓃𝓉 𝓋𝒶𝓁𝓁𝑒𝓎 𝓇𝑒𝓈𝑜𝓇𝓉</span> <span style={{color:'#006400'}}>༺</span> 
